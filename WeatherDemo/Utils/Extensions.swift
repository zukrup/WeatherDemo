...
extension View {
    ...
    func innerShadow<S: Shape, SS: ShapeStyle>(shape: S, color: SS, lineWidth: CGFloat = 1.0, offsetX: CGFloat = 0.0,
                                               offsetY: CGFloat = 0.0, blur: CGFloat = 4.0, blendMode: BlendMode = .normal, opacity: Double = 1.0) -> some View {
